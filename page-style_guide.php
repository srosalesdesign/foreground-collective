...
<main class="wrap hpad clearfix">
  ...
  <section class="clearfix">
    ...
    <div class="threecol first scratch-bg fgreen-bg">
      <div class="white center valign-always">F Green</div>
    </div>
    <div class="threecol scratch-bg fblue-bg">
      <div class="white center valign-always">F Blue</div>
    </div>
    <div class="threecol scratch-bg fmagenta-bg">
      <div class="white center valign-always">F Magenta</div>
    </div>
    <div class="threecol  scratch-bg black-bg">
